...
<a href="javascript:location.replace('http://192.168.10.68/jsp_prj/index.html')" class="btn  btn-secondary btn-sm">메인으로</a>
</div>
</div>
</div>
</c:when>
...
<a href="http://192.168.10.68/jsp_prj/index.html">메인화면</a> | 
