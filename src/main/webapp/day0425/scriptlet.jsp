...
list.add(new DataDTO("img_3.jpg","이건 못참지!!!","오전에 수고하셨고 점심 맛있게 드세요.",
		"https://www.yogiyo.co.kr/mobile/#/"));		
%>
<div>
<% for(DataDTO dto : list){ %>
<div class="card" style="width: 18rem; float:left;margin-right: 10px ">
  <img style="width:280px;height: 160px " src="http://localhost/jsp_prj/common/images/<%= dto.getImg() %>" class="card-img-top" alt="...">
  <div class="card-body">
...
<% 
	...
	int nowDay=ld.getDayOfMonth(); // 현재날짜 얻기
	int lastDayOfMonth=ld.lengthOfMonth();//이번달의 마지막 날짜 
